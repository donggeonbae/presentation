...
- Current status: refreshed with final `Ours / Proposed` full-6k aggregate and rebuilt architecture figure.
...
| Results | Show evidence | Physics-only, supervised baselines, `Ours / Proposed`, real pseudo diagnostic | Metric table and qualitative panel |
...
- Poster PDF rebuilt with the final metric table.
- Architecture figure replaced with the deterministic proposed architecture figure.
