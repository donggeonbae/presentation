...
- Current status: presentation poster archive refreshed from the figure repo specs; 225k, 230k, and 235k full-test evaluations are complete, and the 330k full-test evaluation is running.
...
| Takeaway | Set expectations | Ours beats physics-only; 225k is current best while final 5epoch evaluation runs | concise table and convergence note |
...
| Are the final numbers done? | Not yet. Current paper/poster numbers use the 225k full-test result; the 330k evaluation is running. |
